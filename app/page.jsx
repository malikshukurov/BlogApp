      ...
      <section className="bg-gradient-to-b from-blue-50 via-white to-white py-20">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg text-slate-600 mb-10">
            Bu platforma istifadəçilərə öz bloqlarını yaratmaq,
            məqalələr paylaşmaq, digər insanların yazılarını
            oxumaq və yeni ideyalar kəşf etmək imkanı yaradır.
          </p>
      ...
      <section className="py-20">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-center text-slate-600 max-w-3xl mx-auto mb-16">
            Burada texnologiya, proqramlaşdırma, oyunlar,
            gündəlik həyat, biznes və istənilən mövzuda
            yazılar paylaşa bilərsən.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="border p-8 rounded-2xl">
              ...
              <p className="text-slate-600">
                Başlıq və məzmun əlavə edərək öz bloqunu
                saniyələr ərzində yarat.
              </p>
            ...
            <div className="border p-8 rounded-2xl">
              ...
              <p className="text-slate-600">
                Digər istifadəçilərin paylaşdığı
                bloqları rahatlıqla tap.
              </p>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2">
                Başlıq və məzmun əlavə et
              </h3>

              <p className="text-slate-600">
                Öz fikirlərini paylaş.
              </p>
